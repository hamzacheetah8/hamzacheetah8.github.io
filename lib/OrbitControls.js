...
THREE.OrbitControls = function ( object, domElement ) {
	...
	this.panOffsetXMin = -2;
	this.panOffsetXMax = 2;
	this.panOffsetZMin = -2;
	this.panOffsetZMax = 2;
	...
	this.update = function () {
		...
		return function update() {
			...
			if (
				newX <= this.panOffsetXMax && newX >= this.panOffsetXMin && 
				newZ <= this.panOffsetZMax && newZ >= this.panOffsetZMin
			) {
